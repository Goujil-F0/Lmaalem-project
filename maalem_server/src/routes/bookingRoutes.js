...
const { createNewBooking, seedTestUsers, getBookingHistory, updateStatus } = require('../controllers/bookingController');
...
// Nouvelle route pour modifier le statut (PATCH /api/bookings/:id/status)
